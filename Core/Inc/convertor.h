// conditioner 75Гц фазное 180 ARR 1333 токи 18 20 km 750 kp 5500 ТОКИ РАЗГОНА 180 140 100
...
#ifdef CONDITIONER
/////////////////CONDITIONER
	adc.set_max_current(24);
	adc.set_max_current_phase(26);
